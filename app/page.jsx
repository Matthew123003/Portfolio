      ...
      <div className="container mx-auto h-full">
        ...
        justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            A versatile software developer skilled in Java, Python, and JavaScript, specializing in scalable web apps with React and Node.js. Proficient in Agile, unit testing, MySQL, JSON Server, HTML, CSS, D3.js, Docker, APIs, and CDNs for performance optimization.
            </p>
            {/* btn and socials */}
            <div className="flex flex-col xl:flex-row items-center gap-8">
             <a href="/assets/resume/Matt_Kramer_Resume_Software_SN_1.00.pdf" download>
                <Button 
                variant="outline" 
                size="lg" 
